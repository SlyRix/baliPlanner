...
const A = (t, d) => ({ id: t.slice(0, 12) + Math.random().toString(36).slice(2, 6), t, d, done: false });
  ...
  return {
      stages: [
        { id: 'ubud', name: 'Ubud', dates: '15.–19. Aug', nights: 4, desc: 'Das kulturelle & spirituelle Herz Balis',
          ...
          activities: [
            ...
            A('Kecak Fire & Sunset Dance', 'Feuertanz im Pura Dalem Ubud, täglich 18:30 Uhr. Tickets ~10 €.'),
            A('Tibumana Wasserfall', 'Versteckt & ruhig, 20 Min. von Ubud, kurzer Dschungel-Abstieg. Romantischer als Tegenungan.'),
            A('Ubud Art Market', 'Morgens. Stoffe, Holz, Silber, Batik — handeln ist erwartet, Startpreis halbieren.')
          ],
          food: [
        ...
        { id: 'penida', name: 'Nusa Penida', dates: '19.–21. Aug', nights: 2, desc: 'Wilde, dramatische Küste — unberührt und spektakulär',
          ...
          activities: [
            A('Kelingking Beach', 'Das T-Rex-Kliff — Wahrzeichen der Insel. Abstieg ~45 Min. (steil), unten fast menschenleerer Strand.'),
            A("Broken Beach & Angel's Billabong", 'Direkt nebeneinander: Felsenbrücke über dem Ozean + natürlicher Gezeiten-Pool. Bei rauer See nicht ins Wasser!'),
            A('Diamond Beach', 'Einer der schönsten Strände Balis. Stahltreppe hinunter — weißer Sand, türkises Wasser, Felstürme.'),
            A('Crystal Bay — Schnorcheln', 'Glasklares Wasser. August = Hochsaison für Mola-Mola! Auch Schildkröten & Mantas möglich.'),
            A('Driver für 2 Tage buchen', '~25–30 €/Tag. Straßen sind steil & kurvig — der Driver kennt die besten Fotospots.')
          ],
        ...
        { id: 'gili', name: 'Gili Air', dates: '21.–25. Aug', nights: 4, desc: 'Keine Autos, keine Motorräder — nur Strand, Sterne und Schildkröten',
          ...
          activities: [
            A('Schnorcheln mit Schildkröten', 'Direkt vom Strand! Beste Spots: Turtle Heaven (Nord) & Coral Fan Garden. Ausrüstung ~3 €/Tag.'),
            A('Tauchen', 'Einer der besten Spots Indonesiens. Blue Marine Dive oder Manta Dive, ~35–50 € pro Tauchgang.'),
            A('Inselrundfahrt per Rad', 'In ~45 Min. um die Insel — früh morgens oder abends, vorbei an allen Stränden.'),
            A('Sonnenuntergang Westseite', 'Jeden Abend mit direktem Blick auf den Gunung Agung — einer der schönsten der Reise.'),
            A('Stargazing', 'Keine Lichtverschmutzung — Milchstraße mit bloßem Auge. Einfach nachts am Strand liegen.'),
            A('Swing im Meer', 'Die ikonische Schaukel über dem Wasser — abends hingehen, wenn weniger los ist.')
          ],
          food: [
        ...
        { id: 'uluwatu', name: 'Uluwatu', dates: '25.–29. Aug', nights: 4, desc: 'Klippen, Tempel, Luxus — das spektakulärste Ende Balis',
          ...
          activities: [
            A('Pura Luhur Uluwatu + Kecak — PFLICHT', 'Der ikonischste Tempel Balis auf 70 m Klippe. 18:00 Uhr Kecak Fire Dance am Klippenrand vor Sonnenuntergang. Tickets ~15 €, früh da sein. Vorsicht: Affen klauen Brillen & Handys!'),
            A('Single Fin — Sundowner', 'Legendäre Sunset-Bar hoch über den Surfern. Sonntags Live-Musik.'),
            A('Padang Padang Beach', 'Versteckter Strand durch eine Felsspalte, bekannt aus „Eat Pray Love". Morgens ruhig & schön.'),
            A('Bingin Beach', 'Steiler Abstieg, unten ruhiger Strand mit kleinen Cafés am Wasser. Sehr romantisch.'),
            A('Suluban Beach (Blue Point)', 'Felsformationen, Wellen, Surfer — bei Ebbe die Felsen erkunden.'),
            A('Omnia Dayclub', '1 Nachmittag: Infinity Pool auf der Klippe. Eintritt ~30–50 € (als Getränkeguthaben angerechnet).')
          ],
          food: [
        ...
        { id: 'seminyak', name: 'Seminyak', dates: '29.–30. Aug', nights: 1, desc: 'Letzte Nacht — entspannt ausklingen, nah am Flughafen',
          ...
          activities: [
            A('Letzter Sonnenuntergang', 'Potato Head Beach Club oder Ku De Ta — Cocktail am Strand.'),
            A('Abschluss-Dinner', 'Merah Putih oder La Lucciola.'),
            A('Oberoi Street', 'Spaziergang & letzte Souvenirs.')
          ],
        ...
        { id: 'abflug', name: 'Abflug', dates: '31. Aug', nights: 0, desc: 'Frühstück, Transfer, Abschied von Bali',
